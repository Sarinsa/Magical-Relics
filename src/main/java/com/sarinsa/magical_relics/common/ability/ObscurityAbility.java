...
public class ObscurityAbility extends BaseArtifactAbility {
    ...
    public MutableComponent getAbilityDescription( TriggerType type, ItemStack artifact, @Nullable Level level, TooltipFlag flag ) {
        ...
        return switch( type ) {
            case USER_DAMAGED ->
                    Component.translatable( MagicalRelics.MODID + ".artifact_ability.magical_relics.obscurity.description.user_damaged", EFFECT_DURATION / 20 );
            case USER_ATTACKING ->
                    Component.translatable( MagicalRelics.MODID + ".artifact_ability.magical_relics.obscurity.description.user_attacking", EFFECT_DURATION / 20 );
            default ->
                    Component.translatable( MagicalRelics.MODID + ".artifact_ability.magical_relics.obscurity.description.use", EFFECT_DURATION / 20 );
        };
    }
}
