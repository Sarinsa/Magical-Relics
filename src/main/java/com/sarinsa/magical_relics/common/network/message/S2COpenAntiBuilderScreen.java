...
public class S2COpenAntiBuilderScreen {
    ...
    public static S2COpenAntiBuilderScreen decode( FriendlyByteBuf buffer ) {
        return new S2COpenAntiBuilderScreen( buffer.readInt(), buffer.readInt(), buffer.readInt(), buffer.readInt() );
    }
    
    public static void encode( S2COpenAntiBuilderScreen message, FriendlyByteBuf buffer ) {
