...
public class C2SSaveAntiBuilderData {
    ...
    public final int[] bbCoordinates;
    ...
    public static void encode( C2SSaveAntiBuilderData message, FriendlyByteBuf buffer ) {
        ...
        buffer.writeInt( message.bbCoordinates[0] );
        buffer.writeInt( message.bbCoordinates[1] );
        buffer.writeInt( message.bbCoordinates[2] );
        buffer.writeInt( message.bbCoordinates[3] );
        buffer.writeInt( message.bbCoordinates[4] );
        buffer.writeInt( message.bbCoordinates[5] );
    }
}
