...
public class TranslationUtils {
    ...
    public static final String ABILITY_APPLY_ERROR_4 = "magical_relics.command.ability.apply.error.unsupported_category";
    public static final String ABILITY_APPLY_SUCCESS = "magical_relics.command.ability.apply.success";
